...
burger.addEventListener("click", () => {
    ...
    burger.classList.toggle("_black")
    logo.classList.toggle("_black")
})

const navdecor = document.querySelector(".navdecor")
window.addEventListener("scroll", () => {
    navdecor.classList.toggle("_active", window.scrollY > 0)
})
